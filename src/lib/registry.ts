 ...
 */
export async function fetchPackageInfo(packageName: string): Promise<RegistryResponse> {
 ...
 */
export function extractRepoUrl(info: RegistryResponse, version?: string): { url: string; directory?: string } | null {
